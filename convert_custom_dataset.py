...
def split_text(text: str, n=300, character=" ") -> List[str]:
...
if __name__ =="__main__":
    ...
    csv_to_dataset(csv_path ="/home/wentaoy4/lgm/squad_qa_context.csv",
                   saved_path = "/home/wentaoy4/lgm/convert_dataset/squad_qa_context_dataset")
